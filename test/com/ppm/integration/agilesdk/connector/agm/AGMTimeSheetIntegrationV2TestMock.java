...
@RunWith(PowerMockRunner.class) @PrepareForTest({
        AGMTimeSheetIntegrationV2.class}) public class AGMTimeSheetIntegrationV2TestMock {
    ...
    ClientPublicAPI clientapi = null;
    ...
    @Before public void setUp() throws Exception {
        ...
        PowerMockito.when(clientapi.getAccessTokenWithFormFormat(Mockito.anyString(), Mockito.anyString()))
                .thenReturn(tokenM);
        ArrayList<TimesheetItem> timeSheet1 = new ArrayList<TimesheetItem>();
        Date d1 = new Date(0);
        TimesheetItem onetS = new TimesheetItem();
        onetS.setDate(d1.toString());
        timeSheet1.add(onetS);

        PowerMockito.when(clientapi
                .getTimeSheetData(Mockito.any(AccessToken.class), Mockito.anyString(), Mockito.anyString(),
                        Mockito.anyString(), Mockito.anyInt())).thenReturn(timeSheet1);
    }
